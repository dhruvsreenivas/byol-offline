# From diffuser repo: https://github.com/jannerm/diffuser/blob/main/diffuser/datasets/d4rl.py
...
if __name__ == '__main__':
    # dataset testing
    env = load_environment('hopper-medium-v0')
    traj_dataset = sequence_dataset(env, lambda x: x)
    itr = 0
