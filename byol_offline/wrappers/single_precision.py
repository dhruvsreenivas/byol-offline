...
from byol_offline.types import DataType


def _convert_space(obs_space: gym.Space) -> gym.Space:
...
def _convert_obs(obs: DataType) -> DataType:
...
class SinglePrecision(gym.ObservationWrapper):
    ...
    def observation(self, observation: DataType) -> DataType:
