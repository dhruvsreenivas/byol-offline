...
from byol_offline.networks.predictors import *
...
class DDPG:
    ...
    def update_actor(self, actor_params, encoder_params, critic_params, transitions, key, step):
        ...
        # update both encoder and critic
        actor_update, actor_opt_state = self.critic_opt.update(a_grads, self.train_state.actor_opt_state)
    ...
    def update(self, transitions, step):
        ...
        upd_train_state = DDPGTrainState(
            ...
            rng_key=self.train_state.rng_key # only update RNG key at the end
        )
